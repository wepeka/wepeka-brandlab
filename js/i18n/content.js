...
export default {
  ...
  // ── Report
  "rep2.kind": { en: "Brand report", id: "Report Brand" },
  "rep2.days": { en: "{n} days", id: "{n} hari" },
  "rep2.same": { en: "= same", id: "= sama" },
  "rep2.new": { en: "▲ new", id: "▲ baru" },
  "rep2.points": { en: "{n} pts", id: "{n} poin" },
  "rep2.compare": { en: "▲▼ compared with the period before ({period}).", id: "▲▼ dibanding periode sebelumnya ({period})." },
  "rep2.topSub": { en: "{n} posts published · {healthy} healthy", id: "{n} konten terbit · {healthy} sehat" },
  "rep2.funnelSub": { en: "What the published posts were for", id: "Konten yang terbit dipakai untuk apa" },
  "rep2.funnelItem": { en: "{n} posts · {er} avg. engagement", id: "{n} konten · interaksi {er}" },
  "rep2.salesSub": { en: "{count} sales · {qty} sold", id: "{count} transaksi · {qty} terjual" },
  "rep2.page": { en: "Page {n} of {total}", id: "Halaman {n} dari {total}" },
  "rep.title": { en: "Brand report", id: "Report brand" },
  "rep.btn": { en: "Report PDF", id: "Report PDF" },
  "rep.btnTitle": { en: "Everything in one tidy PDF: content, followers, sales, campaigns, what's next", id: "Semua dalam satu PDF rapi: konten, follower, penjualan, campaign, langkah berikutnya" },
  "rep.making": { en: "Making the PDF…", id: "Lagi bikin PDF…" },
  "rep.downloaded": { en: "Report downloaded.", id: "Report sudah diunduh." },
  "rep.sec.summary": { en: "In short", id: "Ringkasnya" },
  "rep.sec.content": { en: "Content", id: "Konten" },
  "rep.sec.followers": { en: "Followers", id: "Follower" },
  "rep.sec.sales": { en: "Sales", id: "Penjualan" },
  "rep.sec.campaigns": { en: "Campaigns", id: "Campaign" },
  "rep.sec.upcoming": { en: "Scheduled next (2 weeks)", id: "Jadwal berikutnya (2 minggu)" },
  "rep.sec.memory": { en: "What happened & what we learned", id: "Yang terjadi & yang dipelajari" },
  "rep.next": { en: "Next:", id: "Langkah berikutnya:" },
  "rep.sales.count": { en: "Sales logged", id: "Transaksi" },
  "rep.sales.qty": { en: "Sold", id: "Terjual" },
  "rep.sales.revenue": { en: "Revenue", id: "Uang masuk" },
  "rep.sales.from": { en: "Came from:", id: "Asalnya:" },
  "rep.camp.name": { en: "Campaign", id: "Campaign" },
  "rep.camp.stage": { en: "Now at", id: "Sekarang di" },
  "rep.camp.progress": { en: "Targets met", id: "Target tercapai" },
  "rep.camp.headline": { en: "Main number", id: "Angka utama" },
  "rep.th.date": { en: "Date", id: "Tanggal" },
  "rep.lesson": { en: "Lesson {month}:", id: "Pelajaran {month}:" },
  "rep.remind.title": { en: "Time for this week's report", id: "Waktunya report mingguan" },
  "rep.remind.week": { en: "Last 7 days", id: "7 hari terakhir" },
  "rep.remind.published": { en: "{n} posts published", id: "{n} konten terbit" },
  "rep.remind.views": { en: "{n} views", id: "{n} views" },
  "rep.remind.sales": { en: "{rp} in sales", id: "penjualan {rp}" },
  "rep.remind.later": { en: "Later", id: "Nanti" },
  "rep.remind.snoozed": { en: "OK — I'll remind you next week.", id: "Oke — aku ingatkan lagi minggu depan." },
  "rep.generate": { en: "Generate", id: "Buat" },
  "rep.range.week": { en: "Last 7 days", id: "7 hari terakhir" },
