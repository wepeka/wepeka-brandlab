...
export default {
  ...
  "ai.error.thumbGeminiOnly": { en: "Thumbnail generation needs the Gemini provider for now (Settings → AI).", id: "Bikin thumbnail untuk sekarang butuh provider Gemini (Pengaturan → AI)." },
  "ai.error.noImage": { en: "Gemini didn't return an image for this request.", id: "Gemini nggak ngirim gambar untuk permintaan ini." },
  ...
  "ai.error.readNames": { en: "Couldn't read name ideas from the AI's response. Try again.", id: "Gagal membaca ide nama dari jawaban AI. Coba lagi." },
  "ai.error.readNameCheck": { en: "Couldn't read the name check from the AI's response. Try again.", id: "Gagal membaca hasil cek nama dari jawaban AI. Coba lagi." },
  "ai.error.readCampaignPlan": { en: "Couldn't read a campaign plan from the AI's response. Try again.", id: "Gagal membaca rencana campaign dari jawaban AI. Coba lagi." },
