  ...
  if (firstBrandId) {
    steps.push(
      ...
      },
      {
        ...
        title: "Dashboard",
        body: "A quick overview of this brand — content counts, brand assets, and quick actions like Generate Report.",
      },
      {
        selector: '[data-tour="tab-content"]',
        title: "Content",
        body: "Every piece of content for this brand, filterable by status, funnel stage, and format.",
      },
      {
        selector: '[data-tour="tab-creator"]',
        title: "Creator Studio",
        body: "Where you actually write — hooks, scripts, and captions, one piece at a time from idea to published.",
      },
      {
        selector: '[data-tour="tab-calendar"]',
        title: "Calendar",
        body: "Drag content onto a date to schedule it, or use AI Auto-Schedule to fill the month automatically.",
      },
      {
